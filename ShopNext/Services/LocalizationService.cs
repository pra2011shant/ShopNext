...
namespace ShopNext.Services
{
    public class LocalizationService : ILocalizationService
    {
        private static readonly List<LanguageOption> SupportedLanguages = new()
        {
            ...
            new LanguageOption { Code = "hi", Name = "Hindi", NativeName = "हिन्दी", Flag = "🇮🇳" },
            new LanguageOption { Code = "hi-Latn", Name = "Hinglish", NativeName = "Hinglish", Flag = "🇮🇳" },
            new LanguageOption { Code = "bn", Name = "Bengali", NativeName = "বাংলা", Flag = "🇮🇳" },
            new LanguageOption { Code = "mr", Name = "Marathi", NativeName = "मराठी", Flag = "🇮🇳" },
            new LanguageOption { Code = "ta", Name = "Tamil", NativeName = "தமிழ்", Flag = "🇮🇳" },
            new LanguageOption { Code = "te", Name = "Telugu", NativeName = "తెలుగు", Flag = "🇮🇳" },
            new LanguageOption { Code = "gu", Name = "Gujarati", NativeName = "ગુજરાતી", Flag = "🇮🇳" },
            new LanguageOption { Code = "kn", Name = "Kannada", NativeName = "ಕನ್ನಡ", Flag = "🇮🇳" },
            new LanguageOption { Code = "pa", Name = "Punjabi", NativeName = "ਪੰਜਾਬੀ", Flag = "🇮🇳" }
        };
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Dictionaries = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["hi-Latn"] = new(StringComparer.OrdinalIgnoreCase)
            {
                ["Nav_Home"] = "Home",
                ["Nav_Marketplace"] = "Marketplace",
            ...
            ["bn"] = new(StringComparer.OrdinalIgnoreCase)
            {
                ["Nav_Home"] = "হোম",
            ...
            ["mr"] = new(StringComparer.OrdinalIgnoreCase)
            {
                ["Nav_Home"] = "मुख्यपृष्ठ",
                ["Nav_Marketplace"] = "मार्केटप्लेस",
            ...
            ["ta"] = new(StringComparer.OrdinalIgnoreCase)
            {
                ["Nav_Home"] = "முகப்பு",
            ...
            ["te"] = new(StringComparer.OrdinalIgnoreCase)
            {
                ["Nav_Home"] = "హోమ్",
            ...
            ["gu"] = new(StringComparer.OrdinalIgnoreCase)
            {
                ["Nav_Home"] = "હોમ",
            ...
            ["kn"] = new(StringComparer.OrdinalIgnoreCase)
            {
                ["Nav_Home"] = "ಮುಖಪುಟ",
        ...
        public string GetCurrentLanguage(string? cookieLanguage = null)
        {
            if (!string.IsNullOrWhiteSpace(cookieLanguage) && Dictionaries.ContainsKey(cookieLanguage))
            {
        ...
        public string GetString(string key, string? culture = null)
        {
            ...
            if (Dictionaries.TryGetValue(culture, out var dict) && dict.TryGetValue(key, out var val))
            {
                return val;
            }

            if (Dictionaries["en"].TryGetValue(key, out var defaultVal))
            {
                return defaultVal;
            }
        ...
        {
            string raw = GetString(key, culture);
            try
            {
        ...
        public Dictionary<string, string> GetAllStringsForCulture(string culture)
        {
            if (Dictionaries.TryGetValue(culture, out var dict))
            {
                return new Dictionary<string, string>(dict);
            }
            return new Dictionary<string, string>(Dictionaries["en"]);
        }
    }
}
