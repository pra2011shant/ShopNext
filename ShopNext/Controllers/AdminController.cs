    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> GetTabPartial(string tab)
        {
            ...
            return (tab?.ToLowerInvariant()) switch
            {
                ...
                "addressrisk" => PartialView("~/Views/Admin/Partials/_AddressRiskTab.cshtml", vm),
                "multiaccounts" => PartialView("~/Views/Admin/Partials/_MultiAccountsTab.cshtml", vm),
                "products" => PartialView("~/Views/Admin/Partials/_ProductsTab.cshtml", vm),
                "categories" => PartialView("~/Views/Admin/Partials/_CategoriesTab.cshtml", vm),
                "brands" => PartialView("~/Views/Admin/Partials/_BrandsTab.cshtml", vm),
                "orders" => PartialView("~/Views/Admin/Partials/_OrdersTab.cshtml", vm),
                "payments" => PartialView("~/Views/Admin/Partials/_PaymentsTab.cshtml", vm),
                "codabuse" => PartialView("~/Views/Admin/Partials/_CodAbuseTab.cshtml", vm),
                "returns" => PartialView("~/Views/Admin/Partials/_ReturnsTab.cshtml", vm),
                "refunds" => PartialView("~/Views/Admin/Partials/_RefundsTab.cshtml", vm),
                "campaigns" => PartialView("~/Views/Admin/Partials/_CampaignsTab.cshtml", vm),
                "flashsales" => PartialView("~/Views/Admin/Partials/_FlashSalesTab.cshtml", vm),
                "inventoryprotection" => PartialView("~/Views/Admin/Partials/_InventoryProtectionTab.cshtml", vm),
                "salefraud" => PartialView("~/Views/Admin/Partials/_SaleFraudTab.cshtml", vm),
                "smartrisk" => PartialView("~/Views/Admin/Partials/_SmartRiskTab.cshtml", vm),
                "coupons" => PartialView("~/Views/Admin/Partials/_CouponsTab.cshtml", vm),
                "offers" => PartialView("~/Views/Admin/Partials/_OffersTab.cshtml", vm),
                "reviews" => PartialView("~/Views/Admin/Partials/_ReviewsTab.cshtml", vm),
                "complaints" => PartialView("~/Views/Admin/Partials/_ComplaintsTab.cshtml", vm),
                "reports" => PartialView("~/Views/Admin/Partials/_ReportsTab.cshtml", vm),
                "notifications" => PartialView("~/Views/Admin/Partials/_NotificationsTab.cshtml", vm),
                "settings" => PartialView("~/Views/Admin/Partials/_SettingsTab.cshtml", vm),
